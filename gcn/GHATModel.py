...
class GraphAttentionLayer(nn.Module):
    def __init__(self, in_features, out_features, dropout=0.5, alpha=0.2, concat=True, device=device, *args,
                 **kwargs) -> None:
...
class GAT(nn.Module):
    def __init__(self, n_feat, n_hid, pred_length, dropout: float = 0.5, alpha: float = 0.3, n_heads: int = 3, *args,
                 **kwargs) -> None:
